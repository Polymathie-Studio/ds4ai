...
This repository ships **HASP-KEY**, the secrets part, as the `hasp-key` package. The conformance auditor that checks all three altitudes lives in [MISSING](https://github.com/Polymathie-Studio/missing); the response-header and integrity generators are next.
